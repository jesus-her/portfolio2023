...
import { Button, Image, Link, User } from '@nextui-org/react'
...
export default function About () {
  ...
  return (
    ...
    >
      ...
      <User
        className='self-start w-full flex justify-start items-center mb-6'
        name={<p className=' font-semibold text-xl'>Jesús Hernández</p>}
      ...
      <div className='flex flex-col text-left text-base md:text-xl  w-full gap-4 [&>p>strong]:text-primary [&>p>strong]:font-semibold'>
        <p className='max-w-xl'>
          ...
          programming at 18, driven by a desire to utilize technology to address
          real challenges. Currently, I lead teams in crafting innovative
